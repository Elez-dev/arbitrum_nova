...
class ArbSwap(Wallet):
    ...
    @exception_handler('Buy token ArbSwap')
    def buy_token(self, token_to_buy, prescale):
        ...
        self.send_transaction_and_wait(contract_txn, f'Buy {min_tok} {token_to_buy["name"]} ArbSwap')

    @exception_handler('Sold token ArbSwap')
    def sold_token(self, token_to_sold):
        ...
        self.send_transaction_and_wait(contract_txn, f'Sold {min_tok} {token_to_sold["name"]} ArbSwap')

    @exception_handler('Add liquidity ArbSwap')
    def add_liquidity(self, token_to_add):
        ...
        self.send_transaction_and_wait(contract_txn, f'Add {min_tok} {token_to_add["name"]} ArbSwap')

    @exception_handler('Remove Liquidity ArbSwap')
    def remove_liquidity(self, token_to_remove):
        ...
        self.send_transaction_and_wait(contract_txn, f'Remove {token_to_remove["name"]} ArbSwap')
