...
class RpcSwap(Wallet):
    ...
    @exception_handler('Buy token on RpcSwap')
    def buy_token(self, token_to_buy, prescale):
        ...
        self.send_transaction_and_wait(contract_txn, f'Buy {min_tok} {token_to_buy["name"]} RpcSwap')

    @exception_handler('Sold token on RpcSwap')
    def sold_token(self, token_to_sold):
        ...
        self.send_transaction_and_wait(contract_txn, f'Sold {min_tok} {token_to_sold["name"]} RpcSwap')

    @exception_handler('Add Liquidity on RPCswap')
    def add_liquidity(self, token_to_add):
        ...
        self.send_transaction_and_wait(contract_txn, f'Add {min_tok} {token_to_add["name"]} RPCswap')

    @exception_handler('Remove Liquidity on RPCswap')
    def remove_liquidity(self, token_to_remove):
        ...
        self.send_transaction_and_wait(contract_txn, f'Remove {token_to_remove["name"]} RPCswap')
