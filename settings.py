...
remainder_eth  = 0                     # Сколько ETH оставлять на аккаунте (Нужно чтобы хватило на комсу при продаже usdc)
SLIPPAGE       = 5  # %
...
time_delay_min = 20                                                 # Максимальная и
time_delay_max = 30                                                 # Минимальная задержка между транзакциями
...
swap_decimal   = 5                         # Округление, количество знаов после запятой
...
liquidity_decimal   = 6                   # Округление, количество знаов после запятой
